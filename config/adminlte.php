...
return [
    ...
    */
    ...
    'title_postfix' => ' - Vinstella Newsletter System',
    ...
    */
    ...
    'logo' => '<i style="font-size:0.5em">Vinstella</i>Newsletter',

    'logo_mini' => '<b>V</b><i style="font-size:10px">News</i>',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'        => 'Create New ',
            'url'         => 'mail/create',
            'active'      => ['mail/create','/mail/create?*'],
            'icon'        => 'far fa-circle',
        ],
        [
            'text'        => 'Modify Template',
            'url'         => 'mail_template',
            'active'      => ['/mail_template*'],
            'icon'        => 'far fa-circle',
        ],
        ...
        [
            ...
            'active' => ['/admin/action_log','/admin/action_log?*'],
            'icon' => 'far fa-circle',
        ]

        //Admin Menu store at AppServiceProvider
